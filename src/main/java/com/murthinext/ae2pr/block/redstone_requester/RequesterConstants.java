 ...
 * 红石请求器相关常量。
 * <p>
 * 移植自 ME Requester（https://github.com/AlmostReliable/merequester，LGPL-3.0）。
 */
public final class RequesterConstants {

    /** 方块的注册 ID。 */
    public static final String REQUESTER_ID = "redstone_requester";

    private RequesterConstants() {
    }
}
